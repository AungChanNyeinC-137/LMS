...
const Profile = async () => {
  ...
  const session_history = await getUserSessions(user.id);
    ...
    <main className='min-lg:w-3/4'>
      <section className='flex justify-between gap-4 max-sm:flex-col items-center'>
        ...
        <div className="flex gap-4">
          <div className="border border-black rounded-lg p-3 gap-4 flex flex-col h-fit">
            <div className="flex gap-2 items-center">
              <Image src='/icons/check.svg' alt='checkmark' width={22} height={22} />
              <p className="text-2xl font-bold">{session_history.length}</p>
            </div>
